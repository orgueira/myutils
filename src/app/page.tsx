  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-8 sm:p-24 bg-zinc-50 dark:bg-zinc-900">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Tarjeta (Card) para el Conversor PDF */}
        <Link 
        ...
        >
          ...
          <p className="text-zinc-600 dark:text-zinc-400 flex-grow">
            Transforma rápidamente cualquier bloque de texto, apuntes o notas en un documento PDF bien formateado y listo para descargar.
          </p>
        </Link>
